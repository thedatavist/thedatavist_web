...
<img src="1-tableau-published-datasource.png" alt="Tableau Published Datasource" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="2-json-configuration.png" alt="JSON configuration" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="3-mcp-running.png" alt="MCP running" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">

Furthermore, if the MCP server is running, you'll see it in the *search and tools* menu within the main Claude interface. 

<img src="12-tools.png" alt="MCP tools" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">

Claude will also give you the option to turn on and off certain tools within the server itself

<img src="11-see-mcp.png" alt="MCP options" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="4-list-datasources.png" alt="List datasources" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="5-list-columns.png" alt="List columns" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="6-high-rating-players.png" alt="High rating players" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="10-ask-permission.png" alt="Asking permission to run integration" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="6-high-rating-players.png" alt="Fastest players" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="8-top-100.png" alt="Top players" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="9-column-chart.png" alt="Column chart showing countries with most top-100 FIFA players" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
...
<img src="13-full-dashboard.png" alt="Arsenal FIFA 2021 dashboard" style="width: 100%; max-width: 600px; height: auto; border-radius: 8px;">
